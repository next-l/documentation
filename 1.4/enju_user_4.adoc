...
* xref:enju_user_7.adoc[メッセージ機能]を使って知ることができます。
* メールアドレスを設定してある場合は、メールでも通知が来ます。メールアドレスの設定方法は、 xref:enju_user_3.adoc#profile-info[第3章「メールアドレスや名前などを変更する」]をご覧ください。
