...
+
::image:../assets/images/1.4/attachment_edit.png
+
. 編集画面フォームの中ほどにある「ファイル」項目から「ファイルを選択」をクリックしてファイルを追加します。
+
::image:../assets/images/1.4/attachment_file_add.png
+
. ファイル選択時には、ファイル選択ウィンドウから添付したいローカルファイルを選びます。
+
::image:../assets/images/1.4/attachment_file_select.png
+
. 書誌編集フォームの添付ファイル項目にて、選択されたローカルファイルが追加されていることを確認し、フォーム末尾の「更新する」をクリックします。
+
::image:../assets/images/1.4/attachment_file_added.png
+
. 更新された書誌詳細画面にて、添付ファイルへのリンクが付いていることを確認します。
+
::image:../assets/images/1.4/attachment_file_manifestation.png
