...
. <<tsv-import,「TSVファイルを読み込んで登録する」>> の 1. 以降と同じ手順を実行し、3. の時に、[更新]を選ぶと書誌情報が更新できます。
...
. <<tsv-import,「TSVファイルを読み込んで登録する」節>>]の 1. 以降と同じ手順を実行し、所蔵情報を登録できます。
...
. <<tsv-import,「TSVファイルを読み込んで登録する」>> の 1. 以降と同じ手順を実行し、3. の時に、[更新]を選ぶと所蔵情報が更新できます。
...
. <<tsv-import,「TSVファイルを読み込んで登録する」>> の 1. 以降と同じ手順を実行し、3. の時に、[関連を更新する]を選びます。
