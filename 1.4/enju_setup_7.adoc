...
+
image::1.1/image_initial_resque.png[Resqueリンク]

. Resque の画面で非同期処理の状態を確認できます。エラーを確認するには[failed]リンクをたどります。
+
image::1.1/image_initial_resque2.png[failedリンク]

. 詳細なエラーを確認するために、閲覧したいエラーのリンクをたどります。
+
image::1.1/image_initial_resque_3.png[詳細なエラーへのリンク]

. 詳細なエラーが表示されます。
+
image::1.1/image_initial_resque_4.png[詳細なエラー]
