...
+
image::1.1/image_initial_systemdisp01.png[システムの基本的な情報の表示のリンク]
...
+
image::1.1/image_initial_systemdisp03.png[システムの基本的な情報の表示結果]
+
[NOTE]
====
リリース前のパッケージを使用している場合にはコミットのハッシュ値を表示します。

image::1.3/image_initial_systemdisp03-hash.png[システムの基本的な情報のコミットのハッシュを表示]
====
